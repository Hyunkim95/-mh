  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      >
        ...
        {/* Description */}
        <p className="text-white/60 text-sm sm:text-base text-center mb-6 leading-relaxed">
          ...
          <a
            ...
            className="text-[#FBFF69] hover:underline"
          >
            @enigmafund
          </a>{" "}
          on Telegram or{" "}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-[#232628] border rounded-xl text-white placeholder-white/30 focus:outline-none transition-colors ${
                error
                  ? "border-red-500 focus:border-red-500"
                  : "border-white/10 focus:border-[#FBFF69]/50"
              }`}
              autoFocus
            />
            {error && (
