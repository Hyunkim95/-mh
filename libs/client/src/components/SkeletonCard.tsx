...
export const SkeletonCard: React.FC = () => {
  return (
    <div className='w-full h-[82px] rounded-2xl bg-[var(--eerie-black-700-transparency-80)] border border-[var(--white-100-transparency-05)] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04),0_8px_24px_rgba(0,0,0,0.45)] backdrop-blur-sm px-5 py-4 flex items-center animate-pulse'>
