      ...
      <div className="max-w-md mx-auto text-center p-8 bg-white rounded-lg shadow-lg">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-6">
            Please connect your Solana wallet to access the Multihopper
            application. You'll need a connected wallet to create token
            configurations, routes, and manage your hops.
          </p>
        </div>
